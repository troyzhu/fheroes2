...
Built and measured on 2026-08-03. Explained variance moves from $-3.061$, worse than predicting the mean, to $+0.835$, and the value head must be frozen against the shared trunk or teacher agreement falls from 0.887 to 0.701. Whether it improves stage 3 is not yet established: over twenty paired seeds the difference in final win rate was $+0.050 \pm 0.040$. This record is not amended on that evidence, and the stage stays as written.
