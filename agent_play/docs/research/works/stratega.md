...
Where we use it: the reminder that our deterministic ~4,600 eps/s battle core is a first-class planning asset, keep a copyable-state/forward-model door open for MCTS/MuZero-style methods after the process-parallel worker phase ([[../../archive/research-runs/2026-07-27-rl-approaches]] §4).

Related: [[vcmi-gym]], [[misc-pipeline-sources]] (Scaling Scaling Laws with Board Games)
