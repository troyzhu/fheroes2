...
| same | student-played states | $-0.13$, optimistic bias $+0.32$ | extrapolation error, [[../research/works/bcq-extrapolation]] |
| same head, target changed to the undiscounted $\pm 1$ outcome | teacher holdout | 0.09 to about 0.19 | target design: discounting and margin-mixing pollute a position judgment, [[../research/works/alphazero]] uses the plain outcome |
| dedicated value network, own trunk | same outcomes, narrow-army corpora | narrow holdout 0.61; wide-army play, ranking successors | search guided by it wins 0.00 | the frozen trunk was the capacity bind, [[../research/works/muzero]] co-trains; and coverage binds next |
