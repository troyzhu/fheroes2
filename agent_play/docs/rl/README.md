...
| [[program-review]] | The commissioned master review: every approach's verdict, the promising lines ranked, and the remaining experiments, each grounded in a measurement or a works note | Orienting on the whole program, or choosing the next experiment | rewritten 2026-08-09 on the corrected scoreboard |
