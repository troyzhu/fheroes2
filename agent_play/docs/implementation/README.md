...
| [[system-tour]] | The whole pipeline once, engine to training, a snippet or file pointer at every stage | Arriving fresh; read this before any other page here | `src/fheroes2/agent/`, `python/fheroes2_agent/` |
