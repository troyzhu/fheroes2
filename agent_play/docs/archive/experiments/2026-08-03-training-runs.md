...
Ten of thirteen hero armies and 66 of 93 neutral stacks are representable under `simple_v1`. The opening fight was misidentified twice from this data, first as Catarina's unrepresentable Genie battle and then as Ta Arg-Majj's Goblins against a Peasant stack, a proximity-pairing artifact. The owner's correction and a clean dump settled it: the fight is Corribus, the Blue player's hero, 1 Crusader, 1 Crusader, 1 Crusader, 2 Paladins and 2 Champions with hero attack 13 and defense 12, against the 1,000-Peasant stack two tiles away. This table's own extraction had silently dropped the two Champions, because they are wide and the filter kept only `simple_v1` stacks, and the first peasant search missed the stack entirely because the dump prints plural creature names. [[2026-08-04-flip-and-collapse#The Thunk opening fight, pinned down]] carries the corrected measurement.
