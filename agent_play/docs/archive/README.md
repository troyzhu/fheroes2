...
| `experiments/2026-08-08-selfplay-round2-and-trust-region.md` | Self-play round two at settled budgets judged by the full apparatus, the rounds double-check, and the trust-region rematch | Conclusions live in [[../rl/reward-design|reward-design]] and [[../rl/program-review|program-review]] |
